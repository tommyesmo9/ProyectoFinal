...
<H1 class= "text-center"> Adelantos a Empleado</H1>
<br>
...
<div class="form-group">
<input type="text" name="monto_adelanto" value="<?php if (isset($monto_adelanto)) echo($monto_adelanto)?>" class="form-control" style="width: 400px;" placeholder = "Adelanto Realizado al Empleado">
<br>
</div>
<br>
...
<div class="form-group">
<input type="text" name="fecha" value="<?php if (isset($fecha)) echo($fecha)?>" class="form-control" style="width: 400px;"placeholder = "Fecha de Realizado el Adelanto">
<br>
</div>
